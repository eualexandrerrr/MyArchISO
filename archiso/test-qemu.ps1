...
#
# Monitor QEMU em tcp 127.0.0.1:4445 (sendkey, screendump), VNC em 127.0.0.1:5902.
...
$args = @(
  ...
  '-vnc',"127.0.0.1:$VncDisplay",'-display','none','-vga','virtio',
  '-rtc','base=localtime'
)
...
"qemu pid $($p.Id)  monitor 127.0.0.1:$MonitorPort  vnc :$VncDisplay"
